...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/purchase/Public/css/login-seller.css">
    <title>商家登录注册</title>
</head>
...
<input type="hidden" id="basePath" value="/purchase/index.php">
<script type="text/javascript" src="/purchase/Public/libs/jquery/jquery.min.js"></script>
<script type="text/javascript" src="/purchase/Public/libs/layer/layer.js"></script>
<script type="text/javascript" src="/purchase/Public/js/login.js"></script>
<script>
$(function() {
    $('#login_form').submit(function(event) {
        ...
        $.ajax({
            url: basePath+'/Seller/User/login',
            type: 'POST',
            dataType: 'json',
            data: data,
            success: function(data){
                ...
                if(data.code == '0'){
                    layer.msg('登录成功！');
                    setTimeout(function(){
                        window.location.href = basePath + '/Seller/Manage';
                    },1500);
                }else{
                    layer.msg(data.ext);
                }
    ...
    $('#reg_form').submit(function(event) {
        ...
        var basePath = $('#basePath').val();
        $.ajax({
            url: basePath+'/Seller/User/register',
            type: 'POST',
            dataType: 'json',
            data: data,
            success: function(data){
