...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/purchase/Public/css/login-buyer.css">
    <title>买家登录注册</title>
</head>
...
$(function() {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.code == '0'){
                    layer.msg('登录成功！');
                    setTimeout(function(){
                        window.location.href = basePath + '/Buyer/Manage';
                    },1500);
                }else{
                    layer.msg(data.ext);
                }
    ...
    $('#reg_form').submit(function(event) {
        ...
        var basePath = $('#basePath').val();
        $.ajax({
            url: basePath+'/Buyer/User/register',
            type: 'POST',
            dataType: 'json',
            data: data,
            success: function(data){
