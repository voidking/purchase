        ...
        <header class="layout-header">
            ...
            <ul class="header-bar">
                <li class="header-bar-nav">
                    <a href="javascript:;"><?php echo ($buyer["username"]); ?><i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>
    ...
    <div class="col-lg-12 box">
        <form class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="username" placeholder="用户名" disabled="true" value="<?php echo ($buyer["username"]); ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="nickname" class="col-sm-2 control-label">昵称</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="nickname" placeholder="昵称" value="<?php echo ($buyer["buyer_name"]); ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="email" class="col-sm-2 control-label">邮箱</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="email" placeholder="邮箱" value="<?php echo ($buyer["email"]); ?>">
            </div>
          </div>
          <div class="form-group">
            <label for="tel" class="col-sm-2 control-label">手机</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="tel" placeholder="手机" value="<?php echo ($buyer["tel"]); ?>">
            </div>
          </div>
          <div class="form-group">
...
$(function(){
    ...
    $('#updateInfo').click(function(event) {
        ...
        var appPath = $('#appPath').val();
        $.ajax({
            url: appPath+'/Buyer/Manage/update_info',
            type: 'POST',
            dataType: 'json',
            data: data,
            success: function(data){
    ...
    $('#updataPwd').click(function(){
        ...
        var appPath = $('#appPath').val();
        $.ajax({
            url: appPath+'/Buyer/Manage/update_pwd',
            type: 'POST',
            dataType: 'json',
            data: data,
            success: function(data){
